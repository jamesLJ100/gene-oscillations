...
# Total combinations
total_runs <- length(regularisation_strength) * length(iternum) 
...
# Save run log to CSV
output_csv <- file.path(proj_root, "data/dyngen/tuning/scPrisma/grid_search_log.csv")
